...
const Relatorio = () => {
    ...
    const loadDadosIniciais = async () => {
        ...
        try {
            ...
            const agenciasResponse = await axios.get('https://18.118.35.25/api/incomum/relatorio/agencia-by-user/');
        ...
        try {
            ...
            const vendedoresResponse = await axios.get('https://18.118.35.25/api/incomum/relatorio/vendedor-by-user/');
        ...
        try {
            ...
            const areasResponse = await axios.get('https://18.118.35.25/api/incomum/relatorio/list-all-area/');
    ...
    const handleUnidadeChange = async (e) => {
        ...
        try {
            ...
            if (unidadeId) {
                areasResponse = await axios.get(`https://18.118.35.25/api/incomum/relatorio/list-all-areas/`, {
    ...
    const fetchAgencias = async (selectedAreaComercial: string | any[]) => {
        ...
        if (selectedAreaComercial.length > 0) {
            try {
                const response = await axios.get(`https://18.118.35.25/api/incomum/relatorio/agencia-by-user/`, {
    ...
    const handleExport = async () => {
        try {
            const response = await axios.get('https://18.118.35.25/api/incomum/relatorio/download-relatorio/', {
                params: {
                    dataInicio: dateStart?.toISOString().split('T')[0],
                    dataFim: dateEnd?.toISOString().split('T')[0],
