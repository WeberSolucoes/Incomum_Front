...
const TipoAcomodacaoList: React.FC = () => {
    ...
    const getTitle = () => {
        ...
        return truncatedDescricao 
            ? `Cadastro Acomodação - ${truncatedDescricao}` 
            : 'Cadastro Acomodação'; // Título padrão se não houver descrição
    };
    ...
    return (
        <div>
            {view === 'list' ? (
                <>
                    <h1 style={{color:'#0152a1'}}>Consulta de Tipo Acomodação</h1>
...
export default TipoAcomodacaoList;
