...
const CompanhiaList: React.FC = () => {
    ...
    const getTitle = () => {
        ...
        return truncatedDescricao 
            ? `Cadastro Companhia - ${truncatedDescricao}` 
            : 'Cadastro Companhia'; // Título padrão se não houver descrição
    };
    ...
    return (
        <div>
            {view === 'list' ? (
                <>
                    <h1 style={{color:'#0152a1'}}>Consulta de Companhia</h1>
